...
const COPY: Record<Locale, React.ComponentProps<typeof ClarezaUrgenteCampaign>["copy"]> = {
  "pt-BR": {
    ...
    title: "Para a pergunta que continua voltando.",
    ...
    primaryCta: "Começar Clareza Urgente",
    secondaryCta: "Conhecer gratuitamente",
    priceNote: "compra única · depois, você começa no seu Universo",
  ...
  en: {
    ...
    title: "For the question that keeps coming back.",
    ...
    primaryCta: "Start Urgent Clarity",
    secondaryCta: "Try it for free",
    priceNote: "one-time purchase · then start in your Universe",
