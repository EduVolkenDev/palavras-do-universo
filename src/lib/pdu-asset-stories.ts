...
export const PDU_ASSET_STORIES = {
  home: {
    eyebrow: "Como entrar na leitura",
    title: "O portal prepara a sua pergunta antes de revelar as cartas.",
    description: "A experiência conduz a pessoa do primeiro impulso até uma resposta útil: escolher um tema, formular melhor a pergunta, ver as cartas se revelarem e sair com direção prática — sem fatalismo.",
    steps: [
      { label: "Primeiro", title: "Escolha o assunto", text: "Amor, trabalho, momento interno ou uma decisão específica." },
      { label: "Depois", title: "Dê forma à pergunta", text: "A Lume ajuda quando a dúvida ainda está confusa." },
      { label: "Por fim", title: "Leia com direção", text: "As cartas entregam síntese, contexto e próximo passo possível." },
    ],
    items: [
      { src: PDU_ASSETS.homepage.dailyReadingBookCards, alt: "Livro aberto com cartas luminosas", label: "Lume", title: "A Lume organiza o começo", text: "Quando a pergunta ainda está nebulosa, ela ajuda a dar forma ao que você realmente quer entender." },
      { src: PDU_ASSETS.homepage.portalAccessKey, alt: "Portal de acesso com chave luminosa", label: "Autonomia", title: "A decisão continua nas suas mãos", text: "As cartas mostram possibilidades, tensões e próximos passos; elas não fecham destino nem tiram sua escolha." },
      { src: PDU_ASSETS.homepage.questionCard, alt: "Carta luminosa em círculo violeta", label: "Foco", title: "O ruído vira pergunta", text: "Antes da resposta, o portal separa emoção, urgência e contexto para a leitura não virar algo genérico." },
      { src: PDU_ASSETS.homepage.savedMessagesBookmark, alt: "Marcador de mensagem salva em círculo violeta", label: "Continuidade", title: "Voltar sem perder o fio", text: "Conta e histórico mantêm suas leituras reunidas para você perceber padrões com o passar do tempo." },
      { src: PDU_ASSETS.productIcons.threeCardPath, alt: "Três cartas em composição ritualística", label: "Tiradas", title: "Cada jogo responde de um jeito", text: "Carta do Dia, 3 Cartas, Amor, Diamante e outras tiradas mudam estrutura conforme a profundidade da pergunta." },
      { src: PDU_ASSETS.homepage.completedActionsChecklist, alt: "Pergaminho com ações concluídas", label: "Prática", title: "A leitura termina em movimento", text: "A resposta conecta símbolo, síntese e ação possível para a pessoa saber o que fazer depois." },
    ],
  },
  daily: {
  ...
  universe: {
    ...
    items: [
      ...
      { src: PDU_ASSETS.productIcons.weekEnergy, alt: "Imagem visual dos ciclos da semana", label: "Ritmo", title: "Dar forma à semana", text: "Uma âncora visual para acompanhar energia, foco e descanso." },
      { src: PDU_ASSETS.productIcons.loveSignals, alt: "Mapa visual de sinais do amor", label: "Vínculos", title: "Ler os sinais com cuidado", text: "O afeto merece contexto, limite e espaço para mudar." },
      { src: PDU_ASSETS.productIcons.momentMap, alt: "Mapa visual do momento", label: "Orientação", title: "Localizar o agora", text: "Um mapa não escolhe por você; ele ajuda a enxergar onde está." },
      { src: PDU_ASSETS.productIcons.threeCardPath, alt: "Caminho visual das três cartas", label: "Integração", title: "Voltar ao fio da leitura", text: "A jornada fica mais fácil de revisitar quando cada etapa tem uma imagem." },
    ],
  },
  professionals: {
  ...
  auth: {
    ...
    items: [
      { src: PDU_ASSETS.brand.symbol, alt: "Símbolo Palavras do Universo", label: "Identidade", title: "Reconhecer onde você está", text: "O emblema confirma que a entrada pertence ao mesmo portal da leitura." },
      { src: PDU_ASSETS.editorial.portal, alt: "Portal cósmico em tons azuis e violetas", label: "Portal", title: "Uma nova camada da mesma jornada", text: "A conta é a passagem para continuar sem perder o fio do que foi aberto." },
      { src: PDU_ASSETS.ambient.allConnected, alt: "Composição cósmica de conexão", label: "Continuidade", title: "Voltar ao mesmo Universo", text: "Leituras, conta e histórico passam a conversar como partes da mesma jornada." },
      { src: PDU_ASSETS.brand.heroMarkRotation[4].mobileAssetPath, alt: "Dock mobile de Palavras do Universo", label: "Presença", title: "Cabe também no pequeno", text: "A experiência mantém reconhecimento e atmosfera mesmo em telas compactas." },
      { src: PDU_ASSETS.editorial.key, alt: "Chave ritualística dourada", label: "Acesso", title: "Guardar o que é seu", text: "A chave representa proteção para leituras, mensagens e acessos especiais." },
